package me.xtrm.battlehax.utils.fontRenderer;
...
public class GlyphPage {
    ...
    public float drawChar(char ch, double x, double y) {
        ...
        glTexCoord2d(pageX + pageWidth, pageY);
        glVertex2d(x + width, y);

        glTexCoord2d(pageX, pageY);
        glVertex2d(x, y);

        glTexCoord2d(pageX, pageY + pageHeight);
        glVertex2d(x, y + height);

        glTexCoord2d(pageX, pageY + pageHeight);
        glVertex2d(x, y + height);

        glTexCoord2d(pageX + pageWidth, pageY + pageHeight);
